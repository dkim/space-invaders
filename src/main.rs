...
use luminance::{
    ...
    texture::{Dim2, Flat, GenMipmaps, Sampler, Texture, TextureError},
};
...
struct Uniforms {
    sampler: Uniform<&'static BoundTexture<'static, Flat, Dim2, NormUnsigned>>,
}
...
struct Graphics {
    ...
    tessellation: Tess,
    texture: Texture<Flat, Dim2, NormR8UI>,
...
impl Graphics {
    fn new(surface: &mut GlfwSurface) -> Result<Self> {
        ...
        let texture = Texture::<Flat, Dim2, NormR8UI>::new(
            surface,
